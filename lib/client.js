...
Client.prototype.tags = function (callback) {
  this._request('/tags', 'GET', null, callback)
}

Client.prototype.users = function (callback) {
  this._request('/users', 'GET', null, callback)
}
